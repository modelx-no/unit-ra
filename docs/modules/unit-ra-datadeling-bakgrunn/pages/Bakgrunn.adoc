...
:leveloffset: +1
include::master@drafts:unit-ra-datadeling-bakgrunn:page$Forankring.adoc[]
include::master@drafts:unit-ra-datadeling-bakgrunn:page$Målgruppe.adoc[]
include::master@drafts:unit-ra-datadeling-bakgrunn:page$Bruksområder for datadeling.adoc[]
include::master@drafts:unit-ra-datadeling-bakgrunn:page$Økosystemer, tjenestekjeder og tverrgående prosesser.adoc[]
:leveloffset: -1
