...
:leveloffset: +1
include::master@drafts:unit-ra-datadeling-målarkitekturen:page$Muliggjørende kapabiliteter.adoc[]
include::master@drafts:unit-ra-datadeling-målarkitekturen:page$Informasjonsforvaltningsdomener.adoc[]
:leveloffset: -1
